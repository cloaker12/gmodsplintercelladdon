...
-- ============================================================================
-- Advanced tactical night vision system with realistic military features
-- ============================================================================
...
if CLIENT then
    ...
    -- Tactical enhancement variables
    local threatLevel = 0
    ...
    -- Enhanced tactical vision modes
    local visionModes = {
        {
            name = "NIGHTVISION",
            id = "nightvision",
            ...
            powerDrain = 0.3,
            description = "Image intensification with auto-brightness",
            tactical = {
                autoGain = true,
        ...
        },
        {
            ...
            powerDrain = 0.7,
            description = "Heat signature detection with tracking",
            tactical = {
        ...
        },
        {
            ...
            powerDrain = 0.5,
            description = "3D mapping with structural analysis",
            tactical = {
        ...
        },
        {
            ...
            powerDrain = 1.0,
            description = "Multi-spectrum tactical overlay",
            tactical = {
                multiSpectrum = true,
